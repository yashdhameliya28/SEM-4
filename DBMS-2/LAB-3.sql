...
alter procedure PR_employee_detail
...
exec PR_employee_detail 'Jane' , 'Smith' --using firstname and lastname
exec PR_employee_detail 'Jane' --using firstname only
exec PR_employee_detail @LastName = 'Wilson' --using only lastname
